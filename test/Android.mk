...
# calc  
LOCAL_MODULE := TVMediaService  
LOCAL_MODULE_TAGS := eng #optional  
LOCAL_SRC_FILES := TVMediaServiceExec.cpp   
  
#LOCAL_PRELINK_MODULE := false  
LOCAL_SHARED_LIBRARIES := liblog libbinder libutils libTVMediaService
...
LOCAL_MODULE := TVMediaClient
LOCAL_MODULE_TAGS := eng #optional  
LOCAL_SRC_FILES := TVMediaClientExec.cpp   
