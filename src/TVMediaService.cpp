...
//IMPLEMENT_META_INTERFACE(TVMediaService,"com.example.yistn.testservice.TVMediaService");

static TVMediaService* m_active = NULL;

void TVMediaService::instantiate()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    LOGD("instantiate\n");
    LOGD("TVMediaService:ServiceManager: start\n");
    defaultServiceManager()->addService(String16(SERVICE_NAME),new TVMediaService());
    m_active = NULL;
    LOGD("%s line(%d);", __func__, __LINE__);
}

void TVMediaService::iptvMediaMsg(void *arg)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    LOGD("IPTVMediaPlayer msg = %s", (char*)arg);
...
TVMediaService::TVMediaService()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    m_iptvMedia = IPTVMediaService::create(this);
    LOGD("%s line(%d);", __func__, __LINE__);
}
...
void TVMediaService::init(const sp<ITVMediaClient>& client)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    m_client = client;
    LOGD("%s line(%d);", __func__, __LINE__);
...
int TVMediaService::create(const char* url, int id)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int res = -1;
...
void TVMediaService::seek(int time) 
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::fast(int speed) 
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::rewind(int speed)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::setVolume(int volume)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::setMute(int mute)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int  TVMediaService::getPlayMode()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int mode = 0;
    if (m_iptvMedia)
...
int  TVMediaService::getCurrentPos()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int pos = 0;
    if (m_iptvMedia)
...
int  TVMediaService::getVideoPixels()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int pixels = 0;
    if (m_iptvMedia)
...
int  TVMediaService::getDuration()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int duration = 0;
    if (m_iptvMedia)
...
void TVMediaService::setVideoWindow(int x, int y, int width, int height, int mode)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int  TVMediaService::getPlayerInstaceId()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int id = 0;
    if (m_iptvMedia)
...
//liubin add 
char* TVMediaService::set(char*& ioStr, char*& wrStr)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    char* setStr = NULL;
    if (m_iptvMedia)
...
char* TVMediaService::get(char* ioStr)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    char* getStr = NULL;
    if (m_iptvMedia)
...
int TVMediaService::getNativePlayerInstanceID()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setSingleOrPlaylistMode(int mode)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getSingleOrPlaylistMode()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setVideoDisplayMode(int videoDisplayMode)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getVideoDisplayMode()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setVideoDisplayArea(int x, int y, int width, int height)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getVideoDisplayLeft()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
int TVMediaService::getVideoDisplayTop()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
int TVMediaService::getVideoDisplayWidth()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
int TVMediaService::getVideoDisplayHeight()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setNativeUIFlag(int nativeUIFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getNativeUIFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setMuteUIFlag(int muteUIFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getMuteUIFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_MuteUIFlag = 0;
    if (m_iptvMedia)
...
void TVMediaService::setAudioVolumeUIFlag(int audioVolumeUIFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getAudioVolumeUIFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setAudioTrackUIFlag(int audioTrackUIFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getAudioTrackUIFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setProgressBarUIFlag(int progressBarUIFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getProgressBarUIFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setChannelNoUIFlag(int channelNOUIFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getChannelNoUIFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setSubtitileFlag(int subtitileFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getSubtitileFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setAllowTrickmodeFlag(int allowTrickmodeFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getAllowTrickmodeFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setCycleFlag(int cycleFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getCycleFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_CycleFlag = 0;
    if (m_iptvMedia)
...
void TVMediaService::setRandomFlag(int randomFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getRandomFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_RandomFlag = 0;
    if (m_iptvMedia)
...
void TVMediaService::setVendorSpecificAttr(const char*& vendorSpecificAttr)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
char* TVMediaService::getVendorSpecificAttr()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
char* TVMediaService::getMediaCode()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
char* TVMediaService::getCurrentPlayTime()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
int TVMediaService::GetLastError()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_LastError = 0;
    if (m_iptvMedia)
...
char* TVMediaService::getSubtitle()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
int TVMediaService::getMediaCount()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_MediaCount = 0;
    if (m_iptvMedia)
...
int TVMediaService::getCurrentIndex()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
char* TVMediaService::getEntryID()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    char* m_EntryID = NULL;
    if (m_iptvMedia)
...
char* TVMediaService::getPlaylist()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::initMediaPlayer(int nativePlayerInstanceID,
        int playlistFlag,
...
int  TVMediaService::addSingleMedia(int index, const char*& mediaStr)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_SingleMedia = 0;
    if (m_iptvMedia)
...
int TVMediaService::addBatchMedia(const char*& batchMediaStr)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_BatchMedia = 0;
    if (m_iptvMedia)
...
void TVMediaService::removeMediaByEntryID(const char*& entryID)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::removeMediaByIndex(int index)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::clearAllMedia()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaByIndex(const char*& entryID, int toIndex)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaByOffset(const char*& entryID, int offset)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaByIndex1(int index, int toIndex)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaByOffset1(int index, int offset)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaToNext(const char*& entryID)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaToPrevious(const char*& entryID)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaToFirst(const char*& entryID)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaToLast(const char*& entryID)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaToNext1(int index)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaToPrevious1(int index)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaToFirst1(int index)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::moveMediaToLast1(int index)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::selectMediaByIndex(int index)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::selectMediaByOffset(int offset)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::selectNext()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::selectPrevious()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::selectFirst()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::selectLast()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::selectMediaByEntryID(const char*& entryID)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::joinChannel(int userchannelid)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_JoinChannel = 0;
    if (m_iptvMedia)
...
void TVMediaService::leaveChannel()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::playFromStart()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::playByTime(int type, char*& timestamp, int speed)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::switchSubtitle()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::sendVendorSpecificCommand(const char*& xml)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getAudioPID()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_AudioPID = 0;
    if (m_iptvMedia)
...
int TVMediaService::getAudioPIDs()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_AudioPIDs = 0;
    if (m_iptvMedia)
...
void TVMediaService::setAudioPID(int pid)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getSubtitlePID()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_SubtitlePID = 0;
    if (m_iptvMedia)
...
int TVMediaService::getSubtitlePIDs()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setSubtitlePID(int pid)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::Data(int start, int end)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_Data = 0;
    if (m_iptvMedia)
...
int  TVMediaService::bindNativePlayerInstance(int nativePlayerInstanceID)
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::releaseMediaPlayer(int nativePlayerInstanceID)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::setMuteFlag(int muteFlag)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getMuteFlag()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_MuteFlag = 0;
    if (m_iptvMedia)
...
void TVMediaService::setVideoAlpha(int videoAlpha)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
int TVMediaService::getVideoAlpha()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_VideoAlpha = 0;
    if (m_iptvMedia)
...
char* TVMediaService::getPlaybackMode()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
int TVMediaService::getChannelNum()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    int m_ChannelNum = 0;
    if (m_iptvMedia)
...
char* TVMediaService::getCurrentAudioChannel()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
char* TVMediaService::getAudioTrack()
{
    LOGD("%s line(%d);", __func__, __LINE__);
...
void TVMediaService::setSingleMedia(char*& mediaStr)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::refreshVideoDisplay()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::switchAudioChannel()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
void TVMediaService::switchAudioTrack()
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
//game call function                                                                                                                 
void TVMediaService::runGame(const char* values)
{
    LOGD("%s line(%d);", __func__, __LINE__);
    if (m_iptvMedia)
...
status_t BnTVMediaService::onTransact(uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
    ...
    switch(code)
    {
        case MEDIA_INIT:
        {
            LOGD("BnTVMediaService init");
            CHECK_INTERFACE(ITVMediaService,data,reply);
            sp<ITVMediaClient> client = interface_cast<ITVMediaClient>(data.readStrongBinder());
            init(client);
            return NO_ERROR;
        }
        case MEDIA_CREATE:
        {
            LOGD("BnTVMediaService create");
            CHECK_INTERFACE(ITVMediaService,data,reply);
        ...
        {
            CHECK_INTERFACE(ITVMediaService,data,reply);
            char* ioStr = data.readCString();
            char* wrStr = data.readCString();
        ...
        case MEDIA_SETVIDEODISPLAYMODE:
        {
            CHECK_INTERFACE(ITVMediaService,data,reply);
        ...
        case MEDIA_GETVIDEODISPLAYMODE:
        {
            CHECK_INTERFACE(ITVMediaService,data,reply);
        ...
        case MEDIA_SETVIDEODISPLAYAREA:
        {
            CHECK_INTERFACE(ITVMediaService,data,reply);
            int x = data.readInt32();
            int y = data.readInt32();
        ...
        case MEDIA_GETVIDEODISPLAYLEFT:
        {   
            CHECK_INTERFACE(ITVMediaService,data,reply);
        ...
        case MEDIA_GETVIDEODISPLAYWIDTH:
        {
            CHECK_INTERFACE(ITVMediaService,data,reply);
        ...
        case MEDIA_GETVIDEODISPLAYHEIGHT:
        {
            CHECK_INTERFACE(ITVMediaService,data,reply);
        ...
        case MEDIA_SETVENDORSPECIFICATTR:
        {
            CHECK_INTERFACE(ITVMediaService,data,reply);
        ...
        case MEDIA_GETVENDORSPECIFICATTR:
        {
            CHECK_INTERFACE(ITVMediaService,data,reply);
        ...
        case MEDIA_PLAYBYTIME:
        {
            ...
            char* timestamp = data.readCString();
            int speed = data.readInt32();
