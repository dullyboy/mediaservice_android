#ifndef ITVMEDIASERVICE_H
#define ITVMEDIASERVICE_H
...
/**********************************************/
/*! @class ITVMediaService
  @brief TVMedia Service Proxy Interface class
 ***********************************************/
class ITVMediaService: public IInterface {
    public:
        DECLARE_META_INTERFACE(TVMediaService);
        virtual void init(const sp<ITVMediaClient>& client) = 0;
...
/*        virtual char* set(char*& ioStr, char*& wrStr) = 0;
        ...
        virtual int getChannelNum() = 0; 
        virtual void joinChannel(char *url, char* channelname, int channelid) = 0;
        virtual void leaveChannel() = 0;
        ...
        virtual void playFromStart(char*& mediaStr) = 0;
        virtual void playByTime(int type, char*& timestamp, int speed) = 0;
        virtual void gotoStart() = 0;
        virtual void gotoEnd() = 0;
        virtual void refreshVideoDisplay() = 0;
    ...
    protected:
        enum{
            ...
            MEDIA_GETPLAYMODE,
            MEDIA_GETCURRENTPOS,
            MEDIA_GETVIDEOPIXELS,
            MEDIA_GETDURATION,
            MEDIA_GETVERSION,
            MEDIA_SETVIDEOWINDOW,
            ...
            MEDIA_SETVIDEODISPLAYMODE,
            MEDIA_GETVIDEODISPLAYMODE,
            MEDIA_SETVIDEODISPLAYAREA,
            MEDIA_GETVIDEODISPLAYLEFT,
            MEDIA_GETVIDEODISPLAYTOP,
            MEDIA_GETVIDEODISPLAYWIDTH,
            MEDIA_GETVIDEODISPLAYHEIGHT,
            ...
            MEDIA_SETRANDOMFLAG,
            MEDIA_GETRANDOWFLAG,
            MEDIA_SETVENDORSPECIFICATTR,
            MEDIA_GETVENDORSPECIFICATTR,
            MEDIA_GETMEDIACODE,
...
class BnTVMediaService : public BnInterface<ITVMediaService> {  
    public:  
