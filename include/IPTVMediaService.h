#ifndef IPTVMEDIASERVICE_H 
#define IPTVMEDIASERVICE_H
 ...
 ***********************************************/  
class TVMediaService;
class IPTVMediaService {
    public:
        //static void instantiate();  
        IPTVMediaService(TVMediaService *service);
        virtual ~IPTVMediaService();
        static IPTVMediaService* create(TVMediaService *service);
