#ifndef TVMEDIASERVICE_H 
#define TVMEDIASERVICE_H
 ...
 ***********************************************/  
class IPTVMediaService;

class TVMediaService : public BnTVMediaService
{ 
    public:  
        static void instantiate();  
        static void iptvMediaMsg(void *arg);
        TVMediaService();
        virtual ~TVMediaService();
        virtual void init(const sp<ITVMediaClient>& client);
        virtual int create(const char* url, int id);
        virtual void reset();
        virtual void play();
        virtual void stop();
        virtual void pause();
...
/*        virtual char* set(char*& ioStr, char*& wrStr);
        ...
        //static TVMediaService *m_active;
    //protected:
    
    
    private:
        sp<ITVMediaClient> m_client;
        IPTVMediaService* m_iptvMedia;
}; 
