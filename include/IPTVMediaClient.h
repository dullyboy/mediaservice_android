#ifndef JNITVMEDIACLIENT_H
#define JNITVMEDIACLIENT_H
...
{
    public:
        IPTVMediaClient(getIptvUrl url=0, mediaIptvMsg msg=0);
        virtual ~IPTVMediaClient();
        
        //liubin add 
        //IPTVMediaClient& operator=(IPTVMediaClient& mIPTVMediaClient);
        ...
        virtual void create(const char* url, int id);
        ...
        virtual int  getDuration();//getMediaDuration()
